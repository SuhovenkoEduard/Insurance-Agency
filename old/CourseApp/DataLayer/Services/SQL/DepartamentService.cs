...
namespace CourseApp.DataLayer.Services
{
    public class DepartamentService : Service
    {
        ...
        public virtual IEnumerable<string> GetDepartamentTitlesByFilial(Filial filial)
        {
        ...
        public virtual Departament GetDepartamentByTitleAndFilialId(string title, int filialId)
        {
            var dTypes = adapter.GetAll<DType>();
            var departaments = adapter.GetAll<Departament>();
        ...
        public virtual Departament GetDepartamentById(int departamentId)
        {
            var departaments = adapter.GetAll<Departament>();
